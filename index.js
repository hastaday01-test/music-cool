...
client.login('ODE0NjA4NzA3NDEyMjk1Nzgw.YDgVeg.oq9QfqVHO3STOK3F5sUBErP03XY');
...
////////
   ...
   ///////////////////////////////
    ...
    client.user.setActivity(`Type: ${PREFIX}help | Server ${cilent.guilds.cache.size} Users ${client.guilds.cache.reduce((a, g) => a + g.memberCount, 0)},`, { type: "PLAYING"});
