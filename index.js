...
client.login('ODE0NjA3OTU3MzQ5NjI5OTYy.YDgUxw.VDP4XDRqpQJF-iD3y8YPV9nB85o');
...
////////
   ...
   ///////////////////////////////
    ...
    client.user.setActivity(`Type: ${PREFIX}help | Users ${client.guilds.cache.reduce((a, g) => a + g.memberCount, 0)},`, { type: "PLAYING"});
